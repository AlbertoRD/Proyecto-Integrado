...
<html>
    <head>
        <title>Roadster a Auto Mobile Category Flat Bootstrap Responsive Website Template | About :: w3layouts</title>
    ...
    <body>
        ...
        <div id="home" class="header">
            <div class="container">
                ...
                <div class="banner two">
                    <h2 class="second">Single Page</h2>
                </div>
            </div>
        </div>
        <!--//banner-->
        ...
        <div class="single-sec">
            <div class="container">
                <div class="blog-grid">
                    <div class="news-01 single">
                        <a href="#"> <img src="images/n3.jpg" alt=" " class="img-responsive" /></a>
                        <div class="item_info two">
                            <a href="#">  <h3>Lorem Ipsum is simply </h3></a>
                            <ul>
                            ...
                            <ul class="list">
                                <li>
                                    ...
                                    <div class="col-md-10 data">
                                        <div class="title"><a href="#">Designer</a><br><span class="m_14">Aug 30, 2015</span></div>
                                ...
                                <li>
                                    <div class="col-md-2 preview"><a href="#"><img src="images/co.png" class="img-responsive" alt=""></a></div>
                                    <div class="col-md-10 data">
                                        <div class="title"><a href="#">Designer</a><br><span class="m_14">Sep 2, 2015</span></div>
                                        <p>Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature</p>
                                        <h5 class="m_26"> <a href="#">reply</a></h5>
                                    </div>
                                    <div class="clearfix"></div>
                                ...
                                <li>
                                    <div class="col-md-2 preview"><a href="#"><img src="images/co.png" class="img-responsive" alt=""></a></div>
                                    <div class="col-md-10 data">
                                        <div class="title"><a href="#">Designer</a><br><span class="m_14">Nov 2, 2015</span></div>
                                        <p>Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature</p>
                                        <h5 class="m_26"> <a href="#">reply</a></h5>
                                    </div>
                                    <div class="clearfix"></div>
